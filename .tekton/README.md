...
To modify the pipelines for `notebooks` in the `rhoai-2.23-multi-arch-poc` release:
...
```bash
git commit -am "Update pipelinerun for notebooks (rhoai-2.23-multi-arch-poc)"
